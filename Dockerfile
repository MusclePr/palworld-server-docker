FROM golang:1.23.6-alpine AS rcon-cli_builder
...
RUN chmod +x /home/steam/server/autopause/*.sh && \
    ln -sf /home/steam/server/autopause/is_safe_timing.sh /usr/local/bin/is_safe_timing && \
...
RUN ln -sf /home/steam/.mitmproxy/mitmproxy-ca-cert.pem /usr/local/share/ca-certificates/mitmproxy.crt && \
    cp /home/steam/server/autopause/community/etc/sudoers.d/steam /etc/sudoers.d/ && \
