...
| AUTO_PAUSE_ENABLED                         | Enables automatic pause (with ENABLE_PLAYER_LOGGING=true required.)                                                                                                                                 | false                                                                                              | true/false                                                                                                        | 1.3.1           |
| AUTO_PAUSE_TIMEOUT_EST                     | default 180 (seconds) describes the time between the last client disconnect and the pausing of the process (read as timeout established)                                                            | 180                                                                                                | Integer                                                                                                           | 1.3.1           |
| AUTO_PAUSE_KNOCK_INTERFACE                 | The docker default is eth0. Select another NIC if necessary.                                                                                                                                        | eth0                                                                                               | "string"                                                                                                          | 1.3.1           |
| AUTO_PAUSE_LOG                             | Enable auto-pause logging                                                                                                                                                                           | true                                                                                               | true/false                                                                                                        | 1.3.1           |
| AUTO_PAUSE_DEBUG                           | Enable auto-pause debug logging                                                                                                                                                                     | false                                                                                              | true/false                                                                                                        | 1.3.1           |
